...
// Maga_NumericalMethods_Task1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMagaNumericalMethodsTask1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMagaNumericalMethodsTask1App

CMagaNumericalMethodsTask1App::CMagaNumericalMethodsTask1App()
{
...
// Единственный объект CMagaNumericalMethodsTask1App

CMagaNumericalMethodsTask1App theApp;


// Инициализация CMagaNumericalMethodsTask1App

BOOL CMagaNumericalMethodsTask1App::InitInstance()
{
